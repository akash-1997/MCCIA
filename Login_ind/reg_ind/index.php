...
if(isset($_POST['register']))
{
    ...
    else
    {
        ...
        $msg=mysqli_query($con,"insert into login_ind(username,password) values('$useremail','$password')");
        if($msg)
        {
...
<head>
    ...
    <title>Registration Industry Portal</title>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form class="signup-form"  name="signup-form" action="" method="POST">
